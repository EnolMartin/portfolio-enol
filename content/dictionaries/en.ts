...
export const en: Dictionary = {
  portada: {
    nombre: "[[FALTA: nombre, en inglés]]",
    rol: "[[FALTA: rol, en inglés]]",
    entrada: "[[FALTA: párrafo de entrada, en inglés]]",
    titulo: "[[FALTA: title de la portada, en inglés]]",
    descripcion: "[[FALTA: meta description de la portada, en inglés]]",
  },
  secciones: {
    sobreMi: {
