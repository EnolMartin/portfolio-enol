...
export const es = {
  ...
  secciones: {
    sobreMi: {
      ...
      titulo: "[[FALTA: title de Sobre mí, en español]]",
    ...
    proyectos: {
      ...
      titulo: "[[FALTA: title de Proyectos, en español]]",
    ...
    trayectoria: {
      ...
      titulo: "[[FALTA: title de Trayectoria, en español]]",
    ...
    contacto: {
      ...
      titulo: "[[FALTA: title de Contacto, en español]]",
